...
>
  ...
  <div className="bg-pink-50 py-2 text-black">
    <marquee className="text-sm font-bold tracking-wide">
      ...
      {/* Mobile Menu */}
      {isOpen && (
         <div className="lg:hidden max-h-[calc(100dvh-120px)] overflow-y-auto overscroll-y-contain border-t border-pink-100 bg-white/95 backdrop-blur-xl px-4 pb-10 shadow-xl">
    <div className="mx-auto max-w-7xl pt-4 pb-20 space-y-3">
            {navLinks.map((link) => (
              <NavLink
                key={link.path}
                to={link.path}
