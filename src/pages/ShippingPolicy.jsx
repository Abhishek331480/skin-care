    ...
    <section className="min-h-screen overflow-x-hidden bg-gradient-to-b from-pink-50 via-white to-rose-50 py-10 sm:py-14 lg:py-20">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-10 sm:mt-16 grid grid-cols-1 md:grid-cols-3 gap-5 sm:gap-6">
          <div className="rounded-3xl lg:rounded-[2rem] border border-pink-100 bg-white p-5 sm:p-7 shadow-lg shadow-pink-100/50">
            ...
            <p className="mt-3 leading-7 text-gray-600">
              After successful payment, your order is verified and prepared for
              packing.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5 sm:gap-6">
            {shippingSections.map((item, index) => {
              ...
              return (
                <div
                  key={index}
                  className="group rounded-3xl lg:rounded-[2rem] border border-pink-100 bg-white p-5 sm:p-7 shadow-lg shadow-pink-100/40 transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl hover:shadow-pink-100"
                >
          ...
          <div className="flex flex-col gap-5 md:flex-row md:items-center">
            ...
            <div>
              ...
              <p className="mt-2 leading-8 text-gray-600">
                ...
                information may cause delivery delays or failed delivery
                attempts.
              </p>
            </div>
          </div>
        ...
        {/* CTA */}
        <div className="mt-10 sm:mt-16 overflow-hidden rounded-3xl lg:rounded-[2.5rem] bg-gradient-to-r from-pink-600 to-rose-500 p-6 sm:p-10 text-center text-white shadow-2xl shadow-pink-200">
